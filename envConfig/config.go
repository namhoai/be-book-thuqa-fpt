...
type DbConfig struct {
	...
	SqlUrl     string `envconfig:"SQL_URL" default:"root:12345678a@tcp(127.0.0.1:3306)/library?charset=utf8&parseTime=True&loc=Local"`
	TestSqlUrl string `envconfig:"TEST_SQL_URL" default:"root:12345678a@tcp(127.0.0.1:3306)/test?charset=utf8&parseTime=True&loc=Local"`
}
